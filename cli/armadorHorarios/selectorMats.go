...
// se retorna un error
func newSelectorMats() (*selectorMats, error) {
...
func (m *selectorMats) Update(msg tea.Msg) tea.Cmd {
	var cmd tea.Cmd
...
func (m *selectorMats) View() string {
...
func (m *selectorMats) indexOf() *ep.Materia {
